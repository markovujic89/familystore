...
namespace FamilyStore.Migrations
{
    ...
    [Migration("20240409062557_'AddEmailAndPassword'")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FamilyStore.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FamilyStore.Entities.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FamilyStore.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CompanySubscription", b =>
                {
                    b.HasOne("FamilyStore.Entities.Company", null)
                        .WithMany()
                        .HasForeignKey("CompanySubscriptionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FamilyStore.Entities.Subscription", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SubscriptionUser", b =>
                {
                    ...
                    b.HasOne("FamilyStore.Entities.User", null)
                        .WithMany()
